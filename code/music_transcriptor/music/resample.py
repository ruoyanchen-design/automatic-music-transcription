...
*    Date: 2017
*    Code version: N/A
*    Availability: https://github.com/ChihebTrabelsi/deep_complex_networks/blob/master/musicnet/scripts/resample.py
'''
...
def resample_musicnet(file_in, file_out, frame_rate, frame_rate_out):
    ...
    with open(file_in, 'rb') as f_in:
        data_in = numpy.load(file_in, encoding='latin1', allow_pickle=True)
