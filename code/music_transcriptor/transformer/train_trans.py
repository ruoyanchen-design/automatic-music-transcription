...
def train_model(settings):
    ...
    if os.path.isfile(args.model_path):
        ...
        print("Restore model at epoch %d" % checkpoint['epoch'])

    if os.path.isfile(args.best_model_path):
...
parser.add_argument('--model_path', type=str, default='model/concat.pt',
                    help='path for storing the model checkpoint')
parser.add_argument('--best_model_path', type=str, default='model/concat_best.pt',
                    help='path for storing the best model')
